...
public class DailyRecyclerActivityViewDataAdapter extends RecyclerView.Adapter<DailyRecyclerViewItemHolder> {
    private List<DailyRecyclerViewItem> DailyItemList;

    public DailyRecyclerActivityViewDataAdapter(List<DailyRecyclerViewItem> DailyItemList) {
